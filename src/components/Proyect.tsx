...
const Proyect: FC<IDatosProyect> = ({ descripcion, imagen, tecnologias, titulo, link }) => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <Link to={link2} target="_blank" className="max-w-sm m-4 hover:scale-105 transition-all duration-300 bg-white border border-gray-200 rounded-2xl shadow w-56
      bg-cover bg-center   "
