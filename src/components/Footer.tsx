...
<footer className=" bottom-0 left-0 z-20 w-full p-4 mt-10 bg-slate-950 border-t border-gray-200 shadow md:flex md:items-center md:justify-around md:p-6 dark:bg-gray-800 dark:border-gray-600 transition-all h-11">
